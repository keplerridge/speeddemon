<template>
  <header
    class="bg-speedDemon-darkBlue text-xl sm:text-xl md:text-2xl text-white p-4"
  >
    <nav>
      <ul class="list-none flex justify-between items-center w-full">
        <li class="flex items-center space-x-2">
          ...
          >
            ...
            />
            <span class="p-2">SpeedDemon</span>
          </router-link>
        </li>
